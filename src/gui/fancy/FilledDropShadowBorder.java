 ...
 */
public class FilledDropShadowBorder extends AbstractBorder {
   ...
   private Color _color2 = Color.orange;
    ...
    */
   public FilledDropShadowBorder(String title, int width ) {
      this( title, width, Color.BLACK, Color.WHITE );
   }
    ...
    */
   public FilledDropShadowBorder( String title, int width, Color color, Color color2 ) {
	  _title = title;
      _width = width;
      _color = color;
      _color2 = color2;
   ...
   public void paintBorder( Component c, Graphics g, int x, int y, int width, int height ) {
    ...
    //  g.setColor(Color.white);
      //((Graphics2D)g).fillRoundRect(x, y, width - _width - 1, height - _width - 1 , arc, arc);
      g.setColor( _color);
      ((Graphics2D)g).drawRoundRect(x, y, width - _width - 1, height - _width - 1 , arc, arc);
