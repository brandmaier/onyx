...
public class EdgeCovarianceProxy2 extends EdgeProxy {
	...
	public static int getCollisionExtrusion()
	{
		return 12;
	}
	...
	public void updatePath(Edge edge, GeometricObject r1, GeometricObject r2) {
		...
		if (edge.isDoubleHeaded()) {
			r1 = r1.extrude(getCollisionExtrusion());
			r2 = r2.extrude(getCollisionExtrusion());
		}
